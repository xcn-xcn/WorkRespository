...
namespace SmoreControlLibrary.SMCheckBox
{
    /// <summary>
    /// Class UCCheckBox.
    ...
    public partial class UCCheckBox : UserControl
    {
        ...
        /// 选中改变事件
        /// </summary>
        [Description("选中改变事件"), Category("SmoreControl")]
        ...
        /// </PermissionSet>
        [Description("字体"), Category("SmoreControl")]
        ...
        ///   <IPermission class="System.Security.Permissions.FileIOPermission, mscorlib, Version=2.0.3600.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" version="1" Unrestricted="true" />
        /// </PermissionSet>
        [Description("字体颜色"), Category("SmoreControl")]
        ...
        [Description("文本"), Category("SmoreControl")]
